...
export default class Especimen extends React.Component {
  ...
  constructor(props) {
    ...
    this.IrVistaInterfazPrincipal = this.IrVistaInterfazPrincipal.bind(this);
  }

  //Seccion de metodos
  Metodo() {
    alert("PERRO MARICA :V ");
  }

  IrVistaInterfazPrincipal() {
      ...
      <View style={styles.container}>
        <View style={styles.cuerpo}>
            ...
            <ActionButton icon={<Icon name='fingerprint' size={50} color='#e31a1a'/>} btnOutRange='#ffff' buttonColor="#ffff">
              ...
              <ActionButton.Item buttonColor='#ffff'  onPress={this.IrVistaInterfazPrincipal}> 
                <Icon name='home' color='#e31a1a' size={30}/>
              </ActionButton.Item>
