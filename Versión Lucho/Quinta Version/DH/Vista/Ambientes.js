...
export default class Ambientes extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = { datos: "", estaCargado: true, eliminar: null, id: null, consultarAmbientes:"http://192.168.1.3/ServiciosxDH/A/RxA.php",consultaEliminar:"http://192.168.1.3/ServiciosxDH/A/DxA.php?id=",};
