        ...
        while (true) {
            ...
            try {
                ...
                try {
                    ...
                    String servicio = "http://localhost/ServiciosxDh/SimuladorConsultaBD.php?id=1";
        ...
        while (true) {
            ...
            try {
                ...
                try {
                    ...
                    String servicio = "http://localhost/ServiciosxDh/SimuladorConsultaBD.php?id=2";
                    String respuestaServicio = HttpRequest.get(servicio).body();
                    String[] arregloInstruccion = respuestaServicio.split("_");
                    System.out.println(Arrays.toString(arregloInstruccion));
                    int idBoton = Integer.parseInt(arregloInstruccion[2]);
        ...
        while (true) {
            ...
            try {
                ...
                try {
                    ...
                    String servicio = "http://localhost/ServiciosxDh/SimuladorConsultaBD.php?id=3";
                    String respuestaServicio = HttpRequest.get(servicio).body();
                    String[] arregloInstruccion = respuestaServicio.split("_");
                    System.out.println(Arrays.toString(arregloInstruccion));
                    int idBoton = Integer.parseInt(arregloInstruccion[2]);
