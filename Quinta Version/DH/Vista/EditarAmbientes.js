...
export default class EditarAmbientes extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = {nombre:"",cantidadAprendices:"", consultaEditarAmbiente:"http://192.168.1.3/ServiciosxDH/A/UxA.php"};
  ...
  EditarAmbiente(item){
    ...
    if(this.state.nombre==""||this.state.cantidadAprendices==""){
      ...
      consulta = this.state.consultaEditarAmbiente+"?i="+item.idAmbiente+"&n="+this.state.nombre+"&cA="+this.state.cantidadAprendices;
