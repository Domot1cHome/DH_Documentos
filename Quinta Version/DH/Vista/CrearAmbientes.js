...
export default class CrearAmbientes extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.state = {nombre:"",cantidadAprendices:"",consultaCrearAmbiente: "http://192.168.1.3/ServiciosxDH/A/CxA.php"};
  ...
  Metodo(datos){
    ...
    if(this.state.nombre==""||this.state.cantidadAprendices==""){
      ...
      fetch(this.state.consultaCrearAmbiente+"?n="+this.state.nombre+"&cA="+this.state.cantidadAprendices)
